...
light_sampled_results = "/opt/home/s4160469/SmartInv/all_results/sampled_results"
...
def run_large_scale_exp():
	test_dir = "/opt/home/s4160469/SmartInv/tests/contracts"
...
def run_heavy_SmartInv(contract_file, filename, verify=False): 
	...
	print("Invariants found: ", inv)
	torch.cuda.empty_cache()
	_, pruned_inv = prune_for_inv(contract_name)
	print("Pruned invariants are: ", pruned_inv)
...
if __name__ == "__main__":
	...
	sets = ["set1", "set2", "set3"]
	for i in sets:
		test_folder_path = f"/opt/home/s4160469/SmartInv/tests/refined_analysis/natural_bugs/{i}/instrumented"
		for root, _, files in os.walk(test_folder_path):
			for filename in files:
				print(filename)
				contract_file = os.path.join(root, filename)
				run_light_SmartInv(contract_file, filename, False)
	sample_folder = f"/opt/home/s4160469/SmartInv/tests/sample_test/instrumented"
